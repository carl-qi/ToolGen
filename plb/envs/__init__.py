...
ENVS = []
for env_name in ['Move', 'Torus', 'Rope', "Pinch", "Rollingpin", "Chopsticks", "Table", 'TripleMove', 'Assembly']:
    for id in range(5):
        register(
...
register(id='Writer-v1',
         entry_point=f"plb.envs.multitask_env:MultitaskPlasticineEnv",
         kwargs={'cfg_path': "writer.yml", "version": 1},
         max_episode_steps=50)

register(id='MultiTool-v1',
         entry_point=f"plb.envs.multitask_env:MultitaskPlasticineEnv",
         kwargs={'cfg_path': "multi_tool.yml", "version": 1},
         max_episode_steps=50)
...
register(id='Cut-v1',
         entry_point=f"plb.envs.multitask_env:MultitaskPlasticineEnv",
         kwargs={'cfg_path': "cut_test.yml", "version": 1},
         max_episode_steps=100)
register(id='SmallScoop-v1',
         entry_point=f"plb.envs.multitask_env:MultitaskPlasticineEnv",
         kwargs={'cfg_path': "small_scoop.yml", "version": 1},
         max_episode_steps=100)
register(id='LargeScoop-v1',
         entry_point=f"plb.envs.multitask_env:MultitaskPlasticineEnv",
         kwargs={'cfg_path': "large_scoop.yml", "version": 1},
         max_episode_steps=100)
