...
def get_args(cmd=False):
    ...
    parser.add_argument("--tool_model_path", type=str, default=None)
    ...
    parser.add_argument("--component_matching", type=bool, default=False)
    parser.add_argument("--enumerate_contact", type=bool, default=False)
    parser.add_argument("--adam_loss_type", type=str, default="chamfer")
    ...
    parser.add_argument("--eval_plan", type=bool, default=5)
    ...
    parser.add_argument("--train_modules", type=list, default=['reward', 'policy', 'fea'])  # Modules to train
    parser.add_argument("--load_modules", type=list, default=['reward', 'policy', 'fea'])  # Modules to load
    ...
    parser.add_argument("--plan_only", type=bool, default=False) # If plan_only, will not do training
