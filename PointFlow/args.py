...
def add_args(parser):
    ...
    # data options
    parser.add_argument('--pcl_dir_path', type=str, default="plb/envs/tool_pcls/multi_tool")
    parser.add_argument('--num_tools', type=int, default=5)
    parser.add_argument('--input_mode', type=str, default="pc")
    parser.add_argument('--env_name', type=str, default="MultiTool-v1")
    parser.add_argument("--dimtool", type=int, default=8)
    parser.add_argument('--output_steps', type=int, default=10)

    parser.add_argument('--dataset_type', type=str, default="dynabs",
    ...
    parser.add_argument("--tr_max_sample_points", type=int, default=1000,
                        help='Max number of sampled points (train)')
    parser.add_argument("--te_max_sample_points", type=int, default=1000,
                        help='Max number of sampled points (test)')
    parser.add_argument('--num_workers', type=int, default=4,
                        help='Number of data loading threads')
    parser.add_argument('--filter_buffer', type=bool, default=False)
    parser.add_argument('--cached_state_path', type=str, default='datasets/1025_multitool')
